...
const up = (queryInterface) => queryInterface.bulkInsert('Notification', [notificationOne, notificationTwo, notificationThree]);
exports.up = up;
const down = (queryInterface) => queryInterface.bulkDelete('Notification', {}, {});
exports.down = down;
